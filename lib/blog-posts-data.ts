...
export const blogPosts: BlogPost[] = [
    {
      ...
      content: `
        ...
        <ul>
          ...
          <li><strong>Ergonomics & Rigging:</strong> Consider how the camera will be rigged for your shots â€“ handheld, on a gimbal, or tripod.</li>
        </ul>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          <li><strong>The Walk:</strong> Learn the "ninja walk" or "gimbal walk" â€“ a low, smooth gait that minimizes up-and-down motion.</li>
    ...
    },
    {
      ...
      content: `<p>Anamorphic lenses are renowned for their distinctive cinematic look, characterized by oval bokeh, horizontal lens flares, and a wider aspect ratio. They are a favorite among filmmakers aiming for a truly unique and artistic visual style. D'RENTALS offers anamorphic lens rental in Hyderabad, allowing you to achieve this coveted cinematic flair for your projects.</p><p>Renting anamorphic lenses provides access to specialized optics without the significant investment. Our selection includes various focal lengths and squeeze ratios, compatible with professional cinema cameras. Elevate your storytelling with the unique visual characteristics of anamorphic lenses â€“ rent them from us for your next film production.</p>`,
